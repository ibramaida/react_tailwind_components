...
const Showcase = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {/* Main Showcase Area */}
      <main className="relative @container bg-slate-200 dark:bg-slate-900 flex-1 min-h-[calc(100vh-56px)] md:min-h-screen flex items-center justify-center transition-colors duration-300">
